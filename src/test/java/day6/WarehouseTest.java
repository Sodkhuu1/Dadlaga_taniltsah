...
import day6.Location;
import day6.Product;
import day6.Warehouse;
...
public class WarehouseTest {
    ...
    public void testAddProductWithNegativeQuantity() {
        Product validProduct = new Product("Laptop", "Electronics", 1, "12345");
    ...
    public void testAddProductWithInvalidBarcode() {
        Product invalidProduct = new Product("Tablet", "Electronics", 10, "1234"); // 4-digit barcode
        Exception exception = assertThrows(IllegalArgumentException.class, () -> {
            warehouse.addProduct(invalidProduct);
        });
        assertEquals("Barcode ni 5 orontoi baih ystoi", exception.getMessage());
    }
}
